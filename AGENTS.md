...
| `scripts/mac/sideload-hermes.sh` | builds Hermes Agent Desktop fully installed inside a Rocky 8.10 container, snapshots three install paths (`/opt/hermes`, `/usr/local/lib/hermes-agent`, `/usr/local/bin/hermes`) into one tarball. |
